...
<div id="container">
    <main>
        <header>
          <link href="http://localhost/static/style.css" rel="stylesheet">
          <link href="http://localhost/static/normalize.css" rel="stylesheet">
            <div>
                <h2>Olympus Chat App</h2>
            </div>
        </header>
...
<div class="wrapper" style="text-align: center; margin-top: 20px;">
  <p>
      <a href="reset-password.php" class="btn btn-warning" style="width: 200px; text-align: center;">Reset Your Password</a>
      <a href="logout.php" class="btn btn-danger ml-3" style="width: 200px; text-align: center;">Sign Out of Your Account</a>
    </p>
</div>
</body>
</html>
